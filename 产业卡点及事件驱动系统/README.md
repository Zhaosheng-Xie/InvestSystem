...
1. [需求文档 v0.3](01_需求/产业卡点及事件驱动系统_PRD_v0.3.md)
   ...
   - 已批准补充：[PRD v0.4 边界修订补充](01_需求/产业卡点及事件驱动系统_PRD_v0.4边界修订补充.md)及[批准记录](01_需求/产业卡点及事件驱动系统_PRD_v0.4边界修订批准记录.md)，只更正 provider/consumer 所有权，不回写 v0.3。
...
45. [Stage 6 最小历史公共数据消费契约草案 v0.1](../docs/validation/stage6-minimum-public-data-consumption-contract-draft-v0.1.md)
    - 状态：`draft_for_owner_confirmation / zero_runtime_authority`；接受 KB 当前 NOT_READY，提出 P0 数据域、ADV20/Beta120、SSE/SZSE universe、三个 source families + 单一 root、Schema v1 和 repin 顺序。十项 owner 决定全部 pending。
46. [Stage 6 最小历史公共数据消费契约 v0.2](../docs/validation/stage6-minimum-public-data-consumption-contract-v0.2.md)
    - 状态：`owner_approved_governance_contract / zero_runtime_authority`；`S6DATA-01—10` 已整组批准，Beta benchmark 精确固定 `H00985`，其余采用 v0.1 推荐口径。完整机器契约、独立审批谱系和[治理验收](../docs/validation/stage6-minimum-public-data-consumption-contract-v0.2-acceptance.md)已形成，但不授权真实 handoff/backfill/parser/candidate/coverage/historical run/migration/holdout。
47. [ADR-0002 提议](../docs/adr/ADR-0002-kb-provider-contract-consumer-profile-boundary.md)与 [Stage 6 消费与验收 Profile v0.3 草案](../docs/validation/stage6-historical-public-data-consumer-profile-v0.3-draft.md)
...
49. [产业 PRD v0.4 边界修订补充草案](01_需求/产业卡点及事件驱动系统_PRD_v0.4边界修订补充.md)
    - 状态：`owner_approved_by_external_record / zero_runtime_authority`；保持 v0.3 和 pending draft 字节不变，修正 `StrategyInputRef` 所有权、Manifest 校验/投影顺序、对象表和 C1a/C1b 双门。[草案形成验收](../docs/validation/industrial-event-prd-v0.4-boundary-addendum-draft-acceptance.md)通过，[批准记录](01_需求/产业卡点及事件驱动系统_PRD_v0.4边界修订批准记录.md)和[治理批准验收](../docs/validation/industrial-event-prd-v0.4-boundary-addendum-governance-acceptance.md)原子关闭八项。
