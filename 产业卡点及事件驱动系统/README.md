...
47. [ADR-0002 提议](../docs/adr/ADR-0002-kb-provider-contract-consumer-profile-boundary.md)与 [Stage 6 消费与验收 Profile v0.3 草案](../docs/validation/stage6-historical-public-data-consumer-profile-v0.3-draft.md)
    - 状态：`pending_owner / zero_runtime_authority`；保留 v0.2/S6DATA 谱系，把 KB 通用 Release/事实/benchmark/factor/closure 与 IS Adapter、H00985/ADV/Beta 选择、holdout、candidate/coverage、authority 分离。[草案形成验收](../docs/validation/stage6-consumer-boundary-draft-acceptance.md)通过，但 `S6BOUND-01—10` 尚未批准。
