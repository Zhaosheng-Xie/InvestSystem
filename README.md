...
- [InvestSystem 实施计划 v3.33](PLAN.md)：本仓库唯一正式路线图；v0.2/S6DATA 与 ADR-0002/v0.3 边界继续有效。IS 已固定 KB `4352c10` 并完成纯离线 Adapter；[产业 PRD v0.4 边界补充](产业卡点及事件驱动系统/01_需求/产业卡点及事件驱动系统_PRD_v0.4边界修订补充.md)及[批准记录](产业卡点及事件驱动系统/01_需求/产业卡点及事件驱动系统_PRD_v0.4边界修订批准记录.md)已更正 `strategy_input_ref` 所有权，仍不改变真实数据和运行权限。
...
- [产业卡点及事件驱动系统](产业卡点及事件驱动系统/README.md)：PRD v0.3 已于 `2026-07-31` 批准；Stage 2B 最小切片与 Stage 4 完整合成 research-validation 引擎均已验收，完整生产策略仍未实现。
  ...
  - 已批准边界修订：[PRD v0.4 补充](产业卡点及事件驱动系统/01_需求/产业卡点及事件驱动系统_PRD_v0.4边界修订补充.md)
