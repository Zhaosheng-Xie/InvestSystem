...
| Stage 6 | `in_progress / 6B completed_with_scope_limits / 6C first four slices completed_with_scope_limits` | 历史验证与冠军挑战 | 前三切片完成基础和统计，第四切片完成匿名 synthetic champion formula gate；peer/stress/search/phase seal 未完成，正式 run、migration 与 6D 未授权 |
...
| Stage 6 | 6B 验收；6C v0.2 批准/治理验收及[四条 synthetic 切片](docs/validation/stage6c-synthetic-champion-gate-acceptance.md)；`1075 passed, 4 skipped` | peer benchmark、experiment/ablation/stress ledger、统一 phase seal；正式 migration/run authority、PIT readiness、Stage 5D 支持和 6D | `in_progress / 6C first four slices completed_with_scope_limits` |
...
3. Stage 6A/6B 与真实 validation-only seal 已完成；6C v0.2 已批准，前四条匿名合成切片已验收。下一步补 synthetic peer benchmark、experiment/ablation/stress ledger 与统一 phase seal；正式 historical run 仍需另行授权和全部真实前置证据。
